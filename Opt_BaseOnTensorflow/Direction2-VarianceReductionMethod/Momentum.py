...
with tf.name_scope('optimizer'):
    optimizer = tf.train.MomentumOptimizer(learning_rate=learning_rate,momentum=learning_momentum).minimize(cost)
...
plt.plot(all_step, all_loss, color='red', label='Momentum')
plt.legend(loc='best')

# Date: 2018-08-10 08:27
# Author: Enneng Yang
# Abstract：simple DNN problem, optimization is AdaMax
...
with tf.name_scope('optimizer'):
    optimizer = adamax.AdaMaxOptimizer(learning_rate=learning_rate).minimize(cost)
...
plt.plot(all_step, all_loss, color='red', label='AdaMax')
plt.legend(loc='best')
